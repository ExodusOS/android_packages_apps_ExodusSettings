/*
 * Copyright (C) 2014-2021 ExodusOS Project
 *
...
import com.android.internal.util.exodus.ExodusUtils;
import com.android.settings.R;
import com.android.settings.SettingsPreferenceFragment;
import com.android.settings.search.BaseSearchIndexProvider;
import com.android.settingslib.search.SearchIndexable;

import com.exodus.support.preferences.CustomSeekBarPreference;
import com.exodus.support.preferences.SystemSettingSwitchPreference;
import com.exodus.support.preferences.SystemSettingListPreference;

import java.util.ArrayList;
import java.util.List;

@SearchIndexable(forTarget = SearchIndexable.ALL & ~SearchIndexable.ARC)
public class Flashlight extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle icicle) {
        ...
        addPreferencesFromResource(R.xml.exodus_flashlight_settings);
        ...
        if (!ExodusUtils.deviceHasFlashlight(mContext)) {
    ...
    public int getMetricsCategory() {
        return MetricsEvent.EXODUS_CUSTOMISATION;
    }
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider(R.xml.exodus_flashlight_settings);
}